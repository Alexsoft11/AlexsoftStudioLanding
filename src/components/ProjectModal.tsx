    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="flex-1 p-6 md:p-16 overflow-y-auto bg-gradient-to-br from-zinc-900/50 to-black/50">
            <div className="mb-10">
               <span className="text-blue-500 font-mono text-[10px] uppercase tracking-[0.4em] mb-4 block">{project.cat}</span>
               <h2 className="text-3xl sm:text-4xl md:text-7xl font-display font-extrabold mb-6 uppercase tracking-[-0.04em] leading-[0.9]">{project.title}</h2>
               <p className="text-zinc-300 text-lg md:text-xl leading-relaxed font-light mb-8 border-l border-blue-500/30 pl-6">{project.fullDesc}</p>
               
               <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <h5 className="text-[10px] font-display font-bold uppercase text-zinc-500 mb-1 tracking-widest">{t.projects.priceTitle}</h5>
                    <p className="text-blue-500 font-mono text-lg font-bold">{project.price}</p>
                  </div>
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                    <h5 className="text-[10px] font-display font-bold uppercase text-zinc-500 mb-1 tracking-widest">{t.projects.aiBadge}</h5>
                    <p className="text-zinc-200 font-display font-bold uppercase text-[10px] tracking-wider">Integrated & Active</p>
                  </div>
               </div>
