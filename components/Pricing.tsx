    ...
    <section id="pricing" className="py-32 px-6 max-w-screen-xl mx-auto">
      <motion.div {...fadeInUp} className="text-center mb-20">
        <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase">
          {t.pricing.title} <br />
          <span className="font-serif italic normal-case font-light text-blue-500 text-4xl md:text-6xl">{t.pricing.subtitle}</span>
        </h2>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6 auto-rows-[minmax(350px,auto)]">
        ...
        <motion.div 
          {...fadeInUp}
          className="md:col-span-2 p-10 bg-zinc-900/30 border border-white/5 rounded-[2.5rem] hover:border-blue-500/50 transition-all duration-500 flex flex-col group"
        >
          ...
          <h3 className="text-xl font-black mb-1 uppercase tracking-tight leading-tight">{t.pricing.landing.name}</h3>
        ...
        <motion.div 
          ...
          className="md:col-span-4 p-10 bg-gradient-to-br from-blue-600/20 to-zinc-900/30 border border-blue-500/20 rounded-[2.5rem] hover:border-blue-500/50 transition-all duration-500 flex flex-col md:flex-row gap-10 relative overflow-hidden group"
        >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <h3 className="text-3xl font-black mb-2 uppercase tracking-tight leading-tight">{t.pricing.shop.name}</h3>
        ...
        <motion.div 
          ...
          className="md:col-span-4 p-10 bg-zinc-900/30 border border-white/5 rounded-[2.5rem] hover:border-blue-500/50 transition-all duration-500 flex flex-col md:flex-row-reverse gap-10 group"
        >
          <div className="flex-1 flex flex-col">
            ...
            <h3 className="text-3xl font-black mb-2 uppercase tracking-tight leading-tight">{t.pricing.enterprise.name}</h3>
        ...
        >
          ...
          <h3 className="text-xl font-black mb-1 uppercase tracking-tight leading-tight">{t.pricing.kitchen.name}</h3>
